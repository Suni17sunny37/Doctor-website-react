      ...
      <h2 className='text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor font-[700] mt-3 lg:mt-5'>{name}</h2>
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[6px]'>
                <span className='flex ietms-cenetr gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            <div>
                <h3 className='text-[16px] leading-7 lg:text-[18px} lg:leading-[30px] font-semibold text-headingColor'>
                    +{totalPatients}paitents
                </h3>
                <p className='teext-[14px] leading-6 font-[600] text-textColor'>At {hospital}</p>
            </div>
