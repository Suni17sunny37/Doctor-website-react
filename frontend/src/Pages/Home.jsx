        ...
        <div>
          <div className='lg:w-[570px]'>
            ...
            font-[800] md:text-[60px] md:leading-[70px]'>
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae nostrum, quas iusto natus quae cum perferendis provident vel, aperiam quaerat distinctio architecto nulla? Praesentium 
              provident molestiae dolore accusamus sapiente incidunt?</p>
          ...
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            <div>
              <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] textHeadingColor'>
                30+</h2>
      ...
      <div className='flex items-center justify-between flex-col lg:flex-row'>
        ...
        <div className='xl;w-[670px]'>
          ...
          <ul className='pl-4'>
            ...
            use the online scheduling tool to select an appoinment time.</li>
          </ul>
